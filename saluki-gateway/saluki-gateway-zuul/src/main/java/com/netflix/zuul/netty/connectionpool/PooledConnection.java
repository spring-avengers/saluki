...
public class PooledConnection {
  ...
  private static final AttributeKey<PooledConnection> CHANNEL_ATTR =
  ...
  PooledConnection(final Channel channel, final Server server,
      final ClientChannelManager channelManager, final ServerStats serverStats,
      final Counter closeConnCounter, final Counter closeWrtBusyConnCounter) {
