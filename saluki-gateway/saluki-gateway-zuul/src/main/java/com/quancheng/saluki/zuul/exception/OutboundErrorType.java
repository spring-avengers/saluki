...
import static com.quancheng.saluki.zuul.stats.status.ZuulStatusCategory.FAILURE_CLIENT_CANCELLED;
import static com.quancheng.saluki.zuul.stats.status.ZuulStatusCategory.FAILURE_LOCAL;
import static com.quancheng.saluki.zuul.stats.status.ZuulStatusCategory.FAILURE_LOCAL_THROTTLED_ORIGIN_CONCURRENCY;
import static com.quancheng.saluki.zuul.stats.status.ZuulStatusCategory.FAILURE_LOCAL_THROTTLED_ORIGIN_SERVER_MAXCONN;
import static com.quancheng.saluki.zuul.stats.status.ZuulStatusCategory.FAILURE_ORIGIN;
import static com.quancheng.saluki.zuul.stats.status.ZuulStatusCategory.FAILURE_ORIGIN_CONNECTIVITY;
import static com.quancheng.saluki.zuul.stats.status.ZuulStatusCategory.FAILURE_ORIGIN_NO_SERVERS;
import static com.quancheng.saluki.zuul.stats.status.ZuulStatusCategory.FAILURE_ORIGIN_READ_TIMEOUT;
import static com.quancheng.saluki.zuul.stats.status.ZuulStatusCategory.FAILURE_ORIGIN_RESET_CONNECTION;
import static com.quancheng.saluki.zuul.stats.status.ZuulStatusCategory.FAILURE_ORIGIN_THROTTLED;

import com.netflix.client.ClientException;
import com.quancheng.saluki.zuul.stats.status.StatusCategory;
