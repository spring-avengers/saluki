...
import com.quancheng.saluki.zuul.message.HeaderName;
import com.quancheng.saluki.zuul.message.Headers;
import com.quancheng.saluki.zuul.message.http.HttpHeaderNames;
import com.quancheng.saluki.zuul.message.http.HttpRequestMessage;
...
public class ProxyUtils {
  ...
  static {
    REQ_HEADERS_TO_STRIP.add(HttpHeaderNames.CONTENT_LENGTH); // Because the httpclient library sets
                                                              // this itself, and doesn't like it if
                                                              // set by us.
  ...
  public static void addXForwardedHeaders(HttpRequestMessage request) {
    ...
    addXForwardedHeader(headers, HttpHeaderNames.X_FORWARDED_PORT,
