...
/**
 * User: Mike Smith Date: 5/16/15 Time: 2:00 PM
 */
public abstract class SyncEndpoint<I extends ZuulMessage, O extends ZuulMessage>
    extends Endpoint<I, O> implements SyncZuulFilter<I, O> {
  /**
