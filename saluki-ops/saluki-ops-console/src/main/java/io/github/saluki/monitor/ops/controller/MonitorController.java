...
public class MonitorController {
  ...
  public Map<String, List<GrpcnvokeStatistics>> statistics(
  ...
  public List<GrpcnvokeStatistics> statistics(
      @RequestParam(value = "service", required = true) String service,
      @RequestParam(value = "type", required = true) String type,
      @RequestParam(value = "datatype", required = true) String dataType,
      @RequestParam(value = "invokeDateFrom", required = true) String invokeDateFrom,
  ...
  public Map<String, Object> system(@RequestParam(value = "ipPort", required = true) String ipPort)
      throws Exception {
    ...
    try {
      ...
      Map<String, Object> system =
          gson.fromJson(minitorJson, new TypeToken<Map<String, Object>>() {}.getType());
      return system;
    } catch (Exception e) {
      throw e;
    }
