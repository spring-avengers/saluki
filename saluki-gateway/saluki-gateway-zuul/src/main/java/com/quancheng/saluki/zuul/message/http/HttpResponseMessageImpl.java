...
import com.quancheng.saluki.zuul.message.Header;
...
public class HttpResponseMessageImpl implements HttpResponseMessage {
  ...
  public HttpResponseMessageImpl(SessionContext context, Headers headers,
      HttpRequestMessage request, int status) {
    ...
    if (this.outboundRequest.getInboundRequest() == null) {
      LOG.warn(
          "HttpResponseMessage created with a request that does not have a stored inboundRequest! "
  ...
  public ZuulMessage clone() {
    ...
    HttpResponseMessageImpl clone = new HttpResponseMessageImpl(getContext().clone(),
        getHeaders().clone(), getOutboundRequest(), getStatus());
  ...
  protected HttpResponseInfo copyResponseInfo() {
    ...
    HttpResponseMessageImpl response = new HttpResponseMessageImpl(getContext(),
        getHeaders().immutableCopy(), getOutboundRequest(), getStatus());
  ...
  public String toString() {
    return "HttpResponseMessageImpl{" + "message=" + message + ", outboundRequest="
        + outboundRequest + ", status=" + status + ", inboundResponse=" + inboundResponse + '}';
  }
  ...
  public String getInfoForLogging() {
    ...
    StringBuilder sb = new StringBuilder().append(req.getInfoForLogging()).append(",proxy-status=")
        .append(getStatus());
    return sb.toString();
  }
