...
abstract class ConnectionFlowStep {
  ...
  /**
   * <p>
   * Indicates whether or not this step should be executed on the channel's event loop. Defaults to
   * true, can be overridden.
   * </p>
   * 
   * <p>
   * If this step modifies the pipeline, for example by adding/removing handlers, it's best to make
   * it execute on the event loop.
   * </p>
   * 
   * 
   * @return
   ...
   * 
   * <p>
   * The default implementation ignores the message and logs this, since we weren't really expecting
   * a message here.
   * </p>
   * 
   * <p>
   * Some {@link ConnectionFlowStep}s do need to read the messages, so they override this method as
   * appropriate.
   * </p>
   * 
