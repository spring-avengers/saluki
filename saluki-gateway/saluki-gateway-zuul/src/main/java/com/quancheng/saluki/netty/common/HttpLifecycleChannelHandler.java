...
public abstract class HttpLifecycleChannelHandler extends CombinedChannelDuplexHandler {
  ...
  public HttpLifecycleChannelHandler(ChannelInboundHandler inboundHandler,
  ...
  protected static boolean fireStartEvent(ChannelHandlerContext ctx, HttpRequest request) {
    ...
    if (state == State.STARTED) {
      ...
      LOG.error(
          "Received a http request on connection where we already have a request being processed. "
  ...
  protected static boolean fireCompleteEventIfNotAlready(ChannelHandlerContext ctx,
