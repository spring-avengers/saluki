 ...
 * 
 * <p>
 * Connecting a {@link ProxyToServerConnection} can involve more than just connecting the underlying
 * {@link Channel}. In particular, the connection may use encryption (i.e. TLS) and it may also
 * establish an HTTP CONNECT tunnel. The various steps involved in fully establishing a connection
 * are encapsulated in the property {@link #connectionFlow}, which is initialized in
...
public class ProxyToServerConnection extends ProxyConnection<HttpResponse> {
   ...
   * 
   * <p>
   * See the documentation for {@link HttpResponseDecoder} for information about why HEAD requests
   * need special handling.
   * </p>
   * 
   * <p>
   * Thanks to <a href="https://github.com/nataliakoval">nataliakoval</a> for pointing out that with
   * connections being reused as they are, this needs to be sensitive to the current request.
   * </p>
   */
